...
// Definimos los colores usados en la app
class AppColors {
  static const Color fondo = Color(0xff014b52);      // Fondo principal
  static const Color fondo2 = Color(0xff015c64);     // Fondo secundario (cartas)
  static const Color fondo3 = Color(0xff013741);     // Fondo del encabezado
  static const Color fondo4 = Color(0xff02b2b2);     // Color para el borde o detalles
  static const Color titulos = Color(0xff948800);    // Color para títulos
  static const Color botones = Color(0xffdc7500);    // Color de los botones
  static const Color efectos = Color(0xff919b02);    // Color de los íconos o pequeños detalles
}
